...
const translations = {
    ar: {
        ...
        "heroSubtitle": "مرحباً بكم في بروتوفوليو الخاص بي، حيث أشارككم شغفي وإبداعي في تطوير الألعاب،والتصميم الجرافيكي، الرسوم والأنيميشن. استكشفوا عالمي الإبداعي من خلال مشاريعي وأعمالي.",
        ...
        "video1Title": "2D Character رسم في Photoshop وتحريك في Unity",
        "video1Duration": "1:38 المدة",
        "video1Time": "4 أيام",
        "video1Desc": "من اجمل التصاميم التي صنعتها قبل 3 سنوين حيث استطعت رسم الكركترات بواسطة Photoshop وتحريك Unity ستعجبكم.",
        "video2Title": "تصميم خارطة العراق بطابع الاهوار العراقية Photoshop",
        "video2Duration": "3:41 المدة",
        "video2Time": "8 ساعات",
        "video2Desc": "عملية تصميم خارطة العراق خلال مسابقة تصميم على منصة المصمم العراقي حاولت ان اجعل التصميم اكثر احترافية باستخدام أدوبي فوتوشوب من التخطيط إلى التنفيذ.",
        "video3Title": "Logo Antro عمل متواضع لانترو شعار شركة Golden Rock G_Team",
        "video3Duration": "11 ثانية",
        "video3Time": "2 أيام",
        "video3Desc": "إنشاء انترو لشركة Golden Rock G_Team كان عمل من الذاكرة وهو احد الاعمال المتواضعة احببت مشاركته معكم.",
        ...
        "gallery6Title": "لعبة Robotos قيد التطوير",
        "animation": "أنيميشن",
